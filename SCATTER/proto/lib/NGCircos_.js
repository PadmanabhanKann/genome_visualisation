            ...
            function NGCircosSCATTER(d) {
              return self.SCATTER[scatteri].map(function(v, i) {
                ...
                return {
                  ...
                  scatter_des: v.des,
                  scatter_link: v.link,
                  scatter_genec: v.genec,
                  scatter_change:v.change,
                  scatter_genep:v.genep,
                  scatter_notes:v.notes,
                  scatter_noc:v.noc,                  
                ...
                SCATTERMouseOn.on("mouseover",function(d){
                      if(self.ticksOffset != undefined){
                        SCATTERMouseOnTooltip.html(function(){if(self.settings.SCATTERMouseOverTooltipsSetting == "style1"){
                              return "<br> type :"+d.scatter_type+"<br>start : "+(parseInt(d.scatter_start)+self.ticksOffset)+"<br>end : "+(parseInt(d.scatter_end)+self.ticksOffset)+" <br>gene: "+d.scatter_name+"<br> gene product :"+d.scatter_genep+"<br> number of copies :"+d.scatter_noc+" <br>change : "+d.scatter_change+"<br> notes :"+d.scatter_notes+""
                     ...
                     ARCMouseOn.on("mouseover",function(d){
                        if(self.ticksOffset != undefined){
                          ARCMouseOnTooltip.html(function(){if(self.settings.ARCMouseOverTooltipsSetting == "style1"){
                              return  "<br> type :"+d.arc_type+"<br>start : "+(parseInt(d.arc_start)+self.ticksOffset)+"<br>end : "+(parseInt(d.arc_end)+self.ticksOffset)+"<br>gene: "+d.arc_name+"<br> gene product :"+d.arc_genep+"<br> number of copies :"+d.arc_noc+" <br>change : "+d.arc_change+"<br> notes :"+d.arc_notes+""
