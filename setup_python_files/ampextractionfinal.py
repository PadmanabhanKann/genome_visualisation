...
"""
    ...
    print(f"SCATTER01 data saved to amp.js with {len(amp_data)} entries (length ≤ 5000).")
...
"""
    ...
    print(f"ARC02 data saved to amparc.js with {len(amparc_data)} entries (length > 5000).")
